...
from typing import ChainMap, NoReturn, Any, Union, Tuple
...
class Procedure:
  ...
  def __init__(self, parms: list[Any], body: Any, env: Environment) -> None:
...
def atom(token: str) -> Union[int, float, Symbol]:
...
def _eval(x: Any, env: Environment = global_env) -> Any:
